...
\]
where $\lambda_i=\beta_{i0}+\sum_{r}x_{ir}\beta_{r}$ and $\lambda_j=\beta_{j0}+\sum_{r}x_{jr}\beta_{r}$. 

The parameter $\beta_{i0}$ quantifies the ability of team $i$.  If  $\beta_{i0}> \beta_{j0}$, then team $i$ has higher chances of beating team $j$. $\{x_{ir}\}_{r}$ are team specific  variables that may influence game results. For example, if we set $x_{i1}=1_{\{\text{team }i \text{ is at home}\}}$, then $\beta_{1}$ expresses home team advantage. The model is estimated through maximum likelihood, and is implemented with R package [BradleyTerry2](https://github.com/hturner/BradleyTerry2).
